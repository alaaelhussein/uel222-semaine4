 ...
 */
final class Version20260129105810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       // $this->addSql('ALTER TABLE article ADD COLUMN published BOOLEAN NOT NULL');
       $this->addSql("ALTER TABLE article ADD COLUMN published BOOLEAN NOT NULL DEFAULT 1");
